...
public class AgentClient {
    ...
    public static void main(String args[]) {
        ...
        System.setProperty("agent.bundle.home", "F://workspaceNMS_new//opennms-1.10.12-1//dist//hyperic-hq-agent//modules//noJRE//target//hyperic-hq-agent-noJRE-1.10.12//hyperic-hq-agent-1.10.12//bundles//agent-1.10.12");
