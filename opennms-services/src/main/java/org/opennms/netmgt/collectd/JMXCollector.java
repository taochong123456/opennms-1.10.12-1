...
public abstract class JMXCollector implements ServiceCollector {
    ...
    public class JMXMultiInstanceCollectionResource extends JMXCollectionResource {
         ...
         * @param name a {@link java.lang.String} object.
         */
        public JMXMultiInstanceCollectionResource(final CollectionAgent agent, final String instance, final String name, final String resourceName) {
            super(agent,name);
            m_inst = instance;
            m_name = name;
            m_resourceName = resourceName;
        ...
        public File getResourceDir(final RrdRepository repository) {
            ...
            final File resourceDir = new File(nodeDir,m_resourceName);
            final File typeDir = new File(resourceDir, m_name);
    ...
    class JMXCollectionSet implements CollectionSet {
        ...
        public List<JMXCollectionResource> getResources() {
        ...
        public void visit(CollectionSetVisitor visitor) {
            ...
            for(JMXCollectionResource m_collectionResource : getResources()){
