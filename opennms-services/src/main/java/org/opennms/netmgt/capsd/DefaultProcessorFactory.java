...
public class DefaultProcessorFactory implements SuspectEventProcessorFactory, RescanProcessorFactory {
     ...
     */
    /** {@inheritDoc} */
    public SuspectEventProcessor createSuspectEventProcessor(String ifAddress,int nodeId) {
        return new SuspectEventProcessor(m_capsdDbSyncer, m_pluginManager, ifAddress,nodeId);
    }
