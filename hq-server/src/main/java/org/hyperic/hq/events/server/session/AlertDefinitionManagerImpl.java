...
import org.opennms.hq.dao.ActionDAO;
import org.opennms.hq.dao.AlertConditionDAO;
import org.opennms.hq.dao.AlertDAO;
import org.opennms.hq.dao.AlertDefinitionDAO;
...
*/
        ...
        for (AlertConditionValue condition : conds) {
            ...
            if (res.getName() == null || res.getName().trim().length() == 0) {
                ...
                String predefinedAlertDefName =null /*cond.describe(dm)*/;
