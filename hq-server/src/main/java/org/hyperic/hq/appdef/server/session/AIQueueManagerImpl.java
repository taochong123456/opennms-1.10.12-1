...
import org.opennms.hq.dao.AIIpDAO;
import org.opennms.hq.dao.AIPlatformDAO;
import org.opennms.hq.dao.AIServerDAO;
...
public class AIQueueManagerImpl implements AIQueueManager {
    ...
    public List<AppdefResource> processQueue(AuthzSubject subject, List<Integer> platformList,
        ...
        AuthzSubject s =null; /*authzSubjectManager.findSubjectById(subject.getId());*/
