...
/**
 * Bootstrap application for starting OpenN
 * MS.
 */
public class Bootstrap {
    ...
    protected static final String OPENNMS_LOG_DIR = "opennms.logDir";
    ...
    protected static void loadProperties(InputStream is) throws IOException {
        ...
        for (Map.Entry<Object, Object> entry : p.entrySet()) {
            ...
            if (value != null) {
                System.setProperty(propertyName, System.getProperty(OPENNMS_HOME_PROPERTY) + File.separator+value.toString());
            }
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        String opennmsHome = args[0];
        //"D:/workspace/workspaceNMS_new/opennms-1.10.12-1/opennms-full-assembly/target/opennms-1.10.12";
        
        System.setProperty(OPENNMS_HOME_PROPERTY, opennmsHome);
        System.setProperty("opennms.logDir", opennmsHome+File.separator+"logs");
