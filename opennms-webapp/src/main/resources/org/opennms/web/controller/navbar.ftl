...
<nav class="navbar navbar-inverse navbar-fixed-top" id="header" role="navigation">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="${baseHref}index.jsp">
        <img id="logo" src="${baseHref}images/horizon_logo.jpg" alt="OpenNMS" onerror="this.src='${baseHref}images/horizon_logo_small.png'" />
      </a>
    </div>
    ...
    <div style="margin-right: 15px" id="navbar" class="navbar-collapse collapse">
		...
		<#if request.remoteUser?has_content >
		  ...
		  <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li><a name="nav-admin-notice-status" href="#" style="white-space: nowrap">通知: <b id="notification${noticeStatus}">${noticeStatus}</b></a></li>
              <#if isAdmin >
                <li><a name="nav-admin-admin" href="${baseHref}admin/index.jsp" style="white-space: nowrap">系统配置</a></li>
              </#if>
              <#if request.remoteUser?has_content >
                <li><a name="nav-admin-logout" href="${baseHref}j_spring_security_logout" style="white-space: nowrap">退出</a></li>
              </#if>
            </ul>
          </li>
		</#if>
