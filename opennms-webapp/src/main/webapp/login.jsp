  ...
  <div class="col-md-6 col-centered">
    <form class="form-horizontal" role="form" action="<c:url value='j_spring_security_check'/>" method="post">
      <div class="form-group">
        <label for="input_j_username" class="col-sm-4 control-label">用户名</label>
        <div class="col-sm-8">
      ...
      <div class="form-group">
        <label for="j_password" class="col-sm-4 control-label">密码</label>
        <div class="col-sm-8">
          <input type="password" class="form-control" id="input_j_password" name="j_password" placeholder="请输入密码">
        </div>
      </div>
