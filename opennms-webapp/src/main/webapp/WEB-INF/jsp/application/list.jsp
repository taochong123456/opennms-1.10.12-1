...
<table>
	<thead>
		<tr>
			<th width="1%">Ack</th>
			<th width="7%"><fmt:message key="asset.name" /></th>
			<th width="19%"><fmt:message key="asset.category" /></th>
			<th width="3%"><fmt:message key="asset.vendor" /></th>
			<th width="13%"><fmt:message key="asset.createTime" /></th>
		</tr>
	</thead>
	<c:forEach items="${assets}" var="asset">
		<tr>
			...
			<td class="divider" valign="middle" rowspan="1"><nobr>
					   <a href="asset/element.htm?node=${asset.nodeId}">${asset.label}</a></nobr> </td>
			<td class="divider" valign="middle" rowspan="1"><nobr>${asset.category}
				</nobr></td>
			<td class="divider bright" valign="middle" rowspan="1"><nobr>${asset.vendor}
				</nobr></td>
			<td class="divider bright" valign="middle" rowspan="1"><nobr>${asset.lastModifiedDate}
				</nobr></td>
		</tr>
	</c:forEach>
