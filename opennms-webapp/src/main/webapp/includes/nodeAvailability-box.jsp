...
<%@page language="java"
	...
	import="org.opennms.web.WebSecurityUtils,
		...
		java.util.*,
        org.springframework.util.Assert,org.opennms.web.outage.*,java.util.*"
%>
...
<%
    ...
    String timelineHeaderUrl = "/apm/rest/timeline/header/" + timelineStart + "/" + timelineEnd + "/";
    String timelineEmptyUrl = "/apm/rest/timeline/empty/" + timelineStart + "/" + timelineEnd + "/" ;
    OutageModel model = new OutageModel();
    Outage[] outages = model.getCurrentOutagesForNode(nodeId);
%>
          ...
          <% if( intf.isManaged() ) { %>
            ...
            <% for( int j=0; j < svcs.length; j++ ) { %>
              <%
                ...
                String timelineUrl = "/apm/rest/timeline/html/" + String.valueOf(nodeId) + "/" + java.net.URLEncoder.encode(ipAddr, "UTF-8") + "/" + java.net.URLEncoder.encode(service.getServiceName(), "UTF-8") + "/" + timelineStart + "/" + timelineEnd + "/";
              %>
