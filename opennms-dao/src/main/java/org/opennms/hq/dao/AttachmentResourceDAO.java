...
public class AttachmentResourceDAO extends AbstractDaoHibernate<AttachmentResource, Integer> implements OnmsDao<AttachmentResource,Integer>
{
    AttachmentResourceDAO() {
        super(AttachmentResource.class);
    }
    ...
    public Collection findFor(Resource r, ViewResourceCategory cat) {
