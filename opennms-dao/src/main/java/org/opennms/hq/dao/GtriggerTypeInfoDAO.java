...
public class GtriggerTypeInfoDAO extends AbstractDaoHibernate<GtriggerTypeInfo, Integer> implements OnmsDao<GtriggerTypeInfo,Integer> {
    GtriggerTypeInfoDAO() {
        super(GtriggerTypeInfo.class);
    }
