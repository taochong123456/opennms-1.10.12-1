...
public class AgentDAO extends AbstractDaoHibernate<Agent, Integer> implements OnmsDao<Agent,Integer>{
    ...
    @SuppressWarnings("unchecked")
    public List<Agent> findOldAgents(String majorVersion) {
        String sql = "from Agent a where " + LIMIT_A_TO_OLD_AGENTS;
        final Query query = getSession().createQuery(sql);
        query.setParameter("serverVersion", majorVersion);
        return query.list();
     ...
     */
    @SuppressWarnings("unchecked")
    public List<Agent> findOldAgentsUsed(String majorVersion) {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<Agent> findUpToDateAgentsUsed(String majorVersion) {
        final String sql = new StringBuilder(150)
        .append("from Agent a where ")
     ...
     */
    public long getNumOldAgents(String majorVersion) {
    ...
    public long getNumVersionUpToDateAgents(String majorVersion) {
        final String sql = new StringBuilder(150)
     ...
     */
    public boolean isAgentOld(Agent agent,String majorVersion) {
        String serverVersion = majorVersion;     
