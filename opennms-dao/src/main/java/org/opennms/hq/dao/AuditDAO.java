...
public class AuditDAO  extends AbstractDaoHibernate<Audit, Integer> implements OnmsDao<Audit,Integer> {
    public AuditDAO() {
        super(Audit.class);
    }
    ...
    public List<Audit> find(PageInfo pInfo, AuthzSubject me, long startTime, long endTime,
