...
public class GalertActionLogDAO extends AbstractDaoHibernate<GalertActionLog, Integer> implements OnmsDao<GalertActionLog,Integer> {
    GalertActionLogDAO() {
        super(GalertActionLog.class);
    }
