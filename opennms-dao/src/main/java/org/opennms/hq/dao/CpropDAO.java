...
public class CpropDAO extends AbstractDaoHibernate<Cprop, Integer> implements OnmsDao<Cprop,Integer> {
    ...
    public CpropDAO(JdbcTemplate jdbcTemplate, CpropKeyDAO cPropKeyDAO) {
        super(Cprop.class);
    ...
    */
    ...
    public String setValue(final AppdefEntityID aID, int typeId, String key, String val)
        ...
        CpropKey propKey = get(aID, typeId, key);
