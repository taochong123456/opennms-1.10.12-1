...
public class AuthzSubjectDAO  extends AbstractDaoHibernate<AuthzSubject, Integer> implements OnmsDao<AuthzSubject,Integer>  {
    private CrispoDAO crispoDao;
    private ResourceTypeDAO resourceTypeDAO;
    private RoleDAO roleDAO;
    private ResourceDAO resourceDAO;

    public AuthzSubjectDAO(CrispoDAO crispoDAO, ResourceTypeDAO resourceTypeDAO,
                           ResourceDAO resourceDAO, RoleDAO roleDAO) {
        super(AuthzSubject.class);
    ...
    public AuthzSubject create(AuthzSubject creator, String name, boolean active, String dsn, String dept,
