...
public class AgentPluginStatusDAO extends AbstractDaoHibernate<AgentPluginStatus, Integer> implements OnmsDao<AgentPluginStatus,Integer> {
    ...
    public AgentPluginStatusDAO(AgentDAO agentDAO, PluginDAO pluginDAO) {
        super(AgentPluginStatus.class);
    ...
    public Map<Plugin, Collection<AgentPluginStatus>> getOutOfSyncAgentsByPlugin(String serverMajorVersion) {
        final Map<Plugin, Collection<AgentPluginStatus>> rtn =
            new HashMap<Plugin, Collection<AgentPluginStatus>>();
        final List<Integer> list = getOutOfSyncPlugins(null,serverMajorVersion);
    ...
    public Map<Agent, Collection<AgentPluginStatus>> getOutOfSyncPluginsByAgent(String serverMajorVersion) {
    ...
    public List<String> getOutOfSyncPluginNamesByAgentId(int agentId,String serverMajorVersion) {
        final List<Integer> ids = getOutOfSyncPlugins(agentId,serverMajorVersion);
     ...
     */
    @SuppressWarnings("unchecked")
    private List<Integer> getOutOfSyncPlugins(Integer agentId,String serverMajorVersion) {
