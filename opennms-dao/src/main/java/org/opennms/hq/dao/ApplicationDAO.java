...
public class ApplicationDAO extends AbstractDaoHibernate<Application, Integer> implements OnmsDao<Application,Integer> {
    ...
    public ApplicationDAO(AppSvcDependencyDAO appSvcDependencyDAO,
    ...
    public void getDependencyTree(Application a) {/*
    ...
    */}
    ...
    void setDependencyTree(Application a) {/*
        ...
        for (int i = 0; i < nodes.size(); i++) {
            ...
            for (int j = 0; j < aNode.getRemovedChildren().size(); j++) {
                ...
                if (dep != null) {
                    appSvcDependencyDAO.delete(dep);
                }
            }
    ...
    */}
    ...
    public void clearResource(Resource res) {
        getSession().createQuery("update Application set resource = null where resource = ?").setParameter(0,
            res).executeUpdate();
    }
