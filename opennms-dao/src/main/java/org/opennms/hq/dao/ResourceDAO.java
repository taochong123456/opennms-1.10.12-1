...
public class ResourceDAO extends AbstractDaoHibernate<Resource, Integer> implements OnmsDao<Resource,Integer> {
    ...
    public Resource create(ResourceType type, Resource prototype, String name, AuthzSubject creator,
    ...
    public Resource findRootResource() {
        return get(AuthzConstants.rootResourceId);
    }
    ...
    public List<Resource> findByResource(AuthzSubject subject, Resource r) {
        ...
        String hql = "select rez from Resource rez ";
    ...
    Collection<Resource> getOrphanedResources() {
        ...
        final String platformHql = new StringBuilder(128)
            ...
            .append(")")
            .toString();
        rtn.addAll(getSession().createQuery(platformHql).setInteger("platformType", AuthzConstants.authzPlatform).list());
        final String serverHql = new StringBuilder(128)
            ...
            .append(")")
            .toString();
        rtn.addAll(getSession().createQuery(serverHql).setInteger("serverType", AuthzConstants.authzServer).list());
        final String serviceHql = new StringBuilder(128)
            ...
            .append(")")
            .toString();
        rtn.addAll(getSession().createQuery(serviceHql).setInteger("serviceType", AuthzConstants.authzService).list());
        return rtn;
