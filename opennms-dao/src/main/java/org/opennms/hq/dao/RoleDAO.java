...
public class RoleDAO extends AbstractDaoHibernate<Role, Integer> implements OnmsDao<Role,Integer> {

    private ResourceDAO resourceDAO;
    private ResourceTypeDAO resourceTypeDAO;
    private ResourceGroupDAO resourceGroupDAO;

    public RoleDAO(ResourceDAO resourceDAO, ResourceTypeDAO resourceTypeDAO,
