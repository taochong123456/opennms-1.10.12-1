...
public class ControlHistoryDAO extends AbstractDaoHibernate<ControlHistory, Integer> implements OnmsDao<ControlHistory,Integer>  {
    
    private JdbcTemplate jdbcTemplate;
    
    public ControlHistoryDAO(JdbcTemplate jdbcTemplate) {
        super(ControlHistory.class);
    ...
    public ControlHistory findByIdAndPopulate(Serializable id) {/*
        ControlHistory controlHistory = get(id);
