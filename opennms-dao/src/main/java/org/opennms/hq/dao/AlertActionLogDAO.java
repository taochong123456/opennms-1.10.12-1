...
public class AlertActionLogDAO extends AbstractDaoHibernate<AlertActionLog, Integer> implements OnmsDao<AlertActionLog,Integer> {
    public AlertActionLogDAO() {
        super(AlertActionLog.class);
    }
