...
public class AlertDefinitionDAO extends AbstractDaoHibernate<AlertDefinition, Integer> implements OnmsDao<AlertDefinition,Integer>,AlertDefinitionDAOInterface {
    ...
    public AlertDefinitionDAO(ActionDAO actDAO, TriggerDAO tDAO,
