...
public class ServiceTypeDAO extends AbstractDaoHibernate<ServiceType, Integer> implements OnmsDao<ServiceType,Integer>  {
    private PlatformDAO platformDAO;

    public ServiceTypeDAO(PlatformDAO platformDAO) {
    ...
    public ServiceType create(String name, String plugin, String description, boolean internal) {
    ...
    public Collection<ServiceType> findByPlugin(String plugin) {
        return getSession().createCriteria(ServiceType.class).add(Restrictions.eq("plugin", plugin)).addOrder(
    ...
    public Collection<ServiceType> findVirtualServiceTypesByPlatform(int platformId) {
        ...
        return getSession().createCriteria(ServiceType.class).createAlias("serverType", "svt").createAlias("svt.platformTypes",
