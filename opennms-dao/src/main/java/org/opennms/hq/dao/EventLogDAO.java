...
public class EventLogDAO extends AbstractDaoHibernate<EventLog, Integer> implements OnmsDao<EventLog,Integer>{
    ...
    public EventLog create(EventLog res) {
    ...
    */
    ...
    public List<EventLog> findByEntityAndStatus(Resource r, AuthzSubject user, long begin, long end,
                                         String status) {/*
    ...
    */
    ...
    public List<EventLog> findByEntity(AuthzSubject subject, Resource r, long begin, long end,
    ...
    */
    ...
    public List<EventLog> findByGroup(Resource g, long begin, long end, Collection<String> eventTypes) {/*
    ...
    */
    ...
    public List<EventLog> findLastByType(Resource proto) {
     ...
     */
    public int deleteLogs(long from, long to, long interval) {
    ...
    */}
    ...
    public boolean[] logsExistPerInterval(Resource resource, AuthzSubject subject, long begin, long end,
                                   int intervals) {
    	return null;
    	/*
