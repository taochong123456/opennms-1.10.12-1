...
public final class DbIfServiceEntry {
    ...
    public final static char SOURCE_FORCED = 'F';

    public final static char SOURCE_UNKNOWN = ' ';

    public final static char NOTIFY_ON = 'Y';

    public final static char NOTIFY_OFF = 'N';

    public final static char NOTIFY_UNKNOWN = ' ';
