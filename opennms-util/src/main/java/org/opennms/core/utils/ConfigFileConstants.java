...
public final class ConfigFileConstants {
     ...
     * **/ 
    public static final int REDIS_CONFIG_FILE_NAME;
    
    /**
     * The monitor category configuration
     * **/
    public static final int MONITORCATEGORY_CONFIG_FILE_NAME;
    /**
    ...
    /**
     * The redis collection configuration file
     * */
    public static final int REDIS_COLLECTION_CONFIG_FILE_NAME;
    /**
    ...
    static {
        ...
        REDIS_COLLECTION_CONFIG_FILE_NAME = 81;
        
        REDIS_CONFIG_FILE_NAME = 82;
        // Allocate and build the mapping of identifiers to names
        //
        
        MONITORCATEGORY_CONFIG_FILE_NAME = 83;
        ...
        FILE_ID_TO_NAME[REDIS_COLLECTION_CONFIG_FILE_NAME] = "redis-datacollection-config.xml";
        FILE_ID_TO_NAME[REDIS_CONFIG_FILE_NAME] = "redis-config.xml";
        FILE_ID_TO_NAME[MONITORCATEGORY_CONFIG_FILE_NAME] = "monitor-category.xml";
    }
