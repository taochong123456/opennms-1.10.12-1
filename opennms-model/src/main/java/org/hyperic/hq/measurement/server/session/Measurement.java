    ...
    implements ContainerManagedTimestampTrackable, Serializable
{
    ...
    public void setDsn(String formula) {
    ...
    public void setBaselinesBag(Collection baselines) {
        _baselines = baselines;
    }

    public Collection getAvailabilityData() {
        return _availabilityData;
    }

    public void setAvailabilityData(Collection availabilityData) {
        _availabilityData = availabilityData;
    }

    public Collection getBaselinesBag() {
        return _baselines;
    }
