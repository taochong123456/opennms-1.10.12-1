...
public class Resource extends AuthzNamedBean implements Comparable<Resource> {
    ...
    public Collection<ResourceGroup> getGroupBag() {
        return _groupBag;
    }

    public void setGroupBag(Collection<ResourceGroup> b) {
        _groupBag = b;
    }
    ...
    public void setFromEdges(Collection<ResourceEdge> e) {
        _fromEdges = e;
    }
    ...
    public void setToEdges(Collection<ResourceEdge> e) {
        _toEdges = e;
    }
     ...
     */
    public String clearNonValidCharacters(String name){
